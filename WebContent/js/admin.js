...
function show_delete(object) {
    ...
    if (object == "user") {
        ...
        show = "<div id='delete_" + object + "'  class='d_form'>"
            + "<h3>请输入删除车辆信息</h3>"
            + "<input type='text' autofocus='autofocus' name='clno' value placeholder='车辆编号' required>"
        ...
        show = "<div id='delete_student'  class='d_form'>"
            + "<h3>请输入删除司机信息</h3>"
            + "<input type='text' autofocus='autofocus' name='sno' value placeholder='工号' required>"
...
function show_alter(object) {
    ...
    if (object == "user") {
        ...
        show = "<div id='alter_class'  class='d_form'>"
            ...
            + "<input type='text' autofocus='autofocus' name='clno' value placeholder='车辆编号' required>"
            + "<p>修改后</p>"
            + "<input type='text' name='after_clno' value placeholder='车辆编号' required>"
            + "<input type='text' name='after_clname' value placeholder='发车时间'>"
            + "<input type='text' name='after_dno' value placeholder='所属学院编号'>"
        ...
        show = "<div id='alter_student'  class='d_form'>"
            ...
            + "<input type='text' autofocus='autofocus' name='sno' value placeholder='工号' required>"
            + "<p>修改后</p>"
            + "<input type='text' name='after_sno' value placeholder='工号' required>"
            ...
            + "<input type='text' name='after_clno' value placeholder='所在车辆编号'>"
...
function show_insert_class() {
    ...
    var show = "<div id='show_insert_class'  class='d_form'>"
        + "<h3>请输入新增车辆信息</h3>"
        + "<input type='text' autofocus='autofocus' name='clno' value placeholder='车辆编号' required>"
        + "<input type='text' name='clname' value placeholder='发车时间'>"
        + "<input type='text' name='dno' value placeholder='所属学院编号'>"
...
function show_insert_student() {
    ...
    var show = "<div id='show_insert_student'  class='d_form'>"
        ...
        + "<input type='text' name='clno' value placeholder='所在车辆编号'>"
